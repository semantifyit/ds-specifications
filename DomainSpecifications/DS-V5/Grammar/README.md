...
The grammar for DS-V5 consists of different node-types, that are used to construct Domain Specifications and Verification Reports. While Domain Specifications evolved into tree-shaped JSON-LD files, the verification reports stay tree-shaped JSON files.
